...
class Data():
    ...
    def get_negative_class_val(self, tag):
        """
        Returns the value used in the dataset to indicate the positive classification choice.
        """
        # FIXME this dependence between tags and metadata is bad; don't know how to fix it right now
        if tag == 'numerical-binsensitive':
            ...
            return self.negative_class_val
    ...
    def delete_some_data(self, data_frame, ):
        """
        删除 data_frame 中 attribution中这个
        """
        attribution, delete_classes
        pass

    def delete_some_data(self, delete_classes):
        pass
